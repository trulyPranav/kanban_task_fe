              ...
              >
                {currentUser ? (
                  currentUser.avatar_url ? (
                    ...
                    <span className="w-6 h-6 rounded-full inline-flex items-center justify-center bg-(--color-surface-2) text-text-2 text-[10px] font-semibold">
                      {getInitials(currentUser.full_name)}
                    </span>
                  )
                ) : (
                  <span className="w-6 h-6 rounded-full inline-flex items-center justify-center bg-(--color-surface-2)">
